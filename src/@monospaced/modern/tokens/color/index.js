...
const mdrnColor = {
  ...
  "color-green-2": "#b5f61a",
  "color-green-2-rgb": "181, 246, 26",
...
const colorTokens = {
  ...
  "color-error": mdrnColor["color-red-6"],
  "color-success": mdrnColor["color-green-6"],
  "color-warning": mdrnColor["color-yellow-6"],
  "color-info": mdrnColor["color-azure-6"],
};
